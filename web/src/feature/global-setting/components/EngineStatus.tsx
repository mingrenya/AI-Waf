                ...
                <div className="flex items-center gap-4 mb-6">
                    ...
                    {isLoading ? (
                        <Badge variant="outline" className="gap-1">
                            ...
                            <span className="">{t("globalSetting.engine.loading")}</span>
                        </Badge>
                    ) : isRunning ? (
                        <Badge variant="outline" className="gap-1 ">
                            <CheckCircle className="h-3 w-3 " />
                            <span className="">{t("globalSetting.engine.running")}</span>
                        </Badge>
                    ) : (
                        <Badge variant="destructive" className="gap-1 ">
                            <XCircle className="h-3 w-3 " />
                            <span className="">{t("globalSetting.engine.stopped")}</span>
                        </Badge>
                    )}
                </div>
