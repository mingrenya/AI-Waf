...
export function SiteTable({ onEdit, onDelete }: SiteTableProps) {
    ...
    const columns: ColumnDef<Site>[] = [
        {
            accessorKey: 'name',
            header: () => <div className="font-medium py-3.5 whitespace-nowrap  dark:text-white">{t('site.name')}</div>,
            cell: ({ row }) => {
        ...
        {
            accessorKey: 'domain',
            header: () => <div className="font-medium py-3.5 whitespace-nowrap  dark:text-white">{t('site.domain')}</div>,
            cell: ({ row }) => {
                const isInactive = !row.original.activeStatus
                return (
        ...
        },
        {
            ...
            header: () => <div className="font-medium py-3.5 whitespace-nowrap  dark:text-white">{t('site.listenPort')}</div>,
            cell: ({ row }) => {
                const isInactive = !row.original.activeStatus
                return (
        ...
        {
            accessorKey: 'backend',
            header: () => <div className="font-medium py-3.5 whitespace-nowrap  dark:text-white">{t('site.backend')}</div>,
            cell: ({ row }) => {
                const isInactive = !row.original.activeStatus
        ...
        },
        {
            ...
            header: () => <div className="font-medium py-3.5 whitespace-nowrap  dark:text-white">{t('site.https')}</div>,
            cell: ({ row }) => {
                const isInactive = !row.original.activeStatus
                ...
                return (
                    <div className={` ${isInactive ? 'text-gray-400 dark:text-gray-500' : ''}`}>
                        {enabled ? (
                            ...
                            <Badge variant="outline" className={`rounded-full px-3 py-1  ${isInactive
        ...
        },
        {
            ...
            header: () => <div className=" font-medium py-3.5 whitespace-nowrap dark:text-white">{t('site.status')}</div>,
            cell: ({ row }) => {
        ...
        },
        {
            ...
            header: () => <div className=" font-medium py-3.5 whitespace-nowrap dark:text-white">{t('site.wafStatus')}</div>,
            cell: ({ row }) => {
                const isInactive = !row.original.activeStatus
